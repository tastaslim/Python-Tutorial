...
method.
See, now say you want to create your own list class which will have all the functionalities of inbuilt list 
along with some extra functionalities of your own. you can do that as well as you can overwrite some of functionalities
of inbuilt class.
"""
...
# We have overridden len method of inbuilt list class.
