...
"""
   ...
   calculating area of Shape. In the beginning we had circular area only but say
   in the future, we want to paint areas of shape like Sphere, Cone, Cylinder and from pass of time different shape comes.
...
"""
But in future what if shape required is Sphere, then we need to change our existing code because radius of sphere is 
