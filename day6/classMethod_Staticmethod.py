...
Hence if you have a use case where u are not using self and cls, probably it is a use case of static method. 
"""
...
object1 = Employee.fromString(employee1)

first, last, age = employee1.split("-")
object2 = Employee(first, last, age)
