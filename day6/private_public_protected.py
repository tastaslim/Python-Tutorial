...
These are used for naming conventions only to tell developers as such we don't enforce this things like we used to do in
C++ or Java using private or protected keywords, but we just use it as convention and whole community follow it.
"""
