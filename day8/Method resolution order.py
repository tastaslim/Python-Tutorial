...
"""Output is quite confusing ha. No because it is showing us hierarchy in such way because Python uses DFS(Depth 
...
Although we learnt this but make sure never ever write this type of code because it is bad code and becomes very complex.
 """
