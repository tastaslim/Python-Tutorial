...
"""
In python we can use mathods with same name using dispatch module.
...
"""
    Yes, below code shows warning because by default we can't declare two function with same name and same parameter, because 
    ultimately latest one will be used and previous will be discarded. But using dispatch decorater we can do
